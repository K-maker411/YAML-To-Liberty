...
@pytest.fixture
def attributes_provider(library_level_simple_attributes_file, library_level_default_attributes_file, library_level_scaling_attributes_file, cell_group_simple_attributes_file, pin_group_simple_attributes_file, timing_group_simple_attributes_file):
