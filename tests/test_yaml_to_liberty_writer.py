...
def test_get_complex_attr_as_string(yaml_to_liberty_writer_simple_gscl45nm_take_2):
  ...
  assert repr(yaml_to_liberty_writer_simple_gscl45nm_take_2.get_complex_attr_as_string(attr_3, value_3) == repr(expected_3))
...
cell(BUFX1) {
  ...
  print("Expected: \n" + expected_4)
  print("Actual: \n" + yaml_to_liberty_writer_simple_gscl45nm_take_2.get_group_as_string_recursive("pin", dict_4))
