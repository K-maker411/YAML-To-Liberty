...
class AttributesProvider:
  def __init__(self, library_level_simple_attributes, library_level_scaling_attributes, library_level_default_attributes, cell_group_simple_attributes, pin_group_simple_attributes, timing_group_simple_attributes):
